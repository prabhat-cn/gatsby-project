    ...
    <>
      <div className="st-content">
        ...
        >
          ...
          <div className="st-slider st-style1">
            <div
            ...
            >
              <div className="slick-wrapper">
                <div className="slick-slide-in">
                  <div
                    className="st-single-slider d-flex align-items-center slider-bg-1 slider-bg-style st-bg"
                    data-src="/assets/img/hero-bg6.jpg"
                  >
                    <div
                      className="st-hero-overlay"
                      data-src="/assets/img/hero-shape.png"
                    ></div>
                        ...
                        <div className="col-xl-12">
                          <div className="st-hero-text st-white">
                            ...
                            <p>
                              ...
                              dolore <br />
                              magna aliquyam voluptua.
                            </p>
                            <div className="st-hero-btn">
                              <a
                                href="about.html"
                                className="btn st-btn-custom st-solid-white"
                              >
                                Read More<i className="fas fa-plus-circle"></i>
                              </a>
                            </div>
                          </div>
                        </div>
                ...
                <div className="slick-slide-in">
                  <div
                    className="st-single-slider d-flex align-items-center slider-bg-2 slider-bg-style st-bg"
                ...
                <div className="slick-slide-in">
                  <div
                    className="st-single-slider d-flex align-items-center slider-bg-3 slider-bg-style st-bg"
            ...
            <div className="pagination st-style1 st-type3"></div>
        ...
        <section className="feature-section st-parallax">
          <div className="st-parallax-shape st-position1 st-to-left st-to-rotate-up">
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-4">
                <div
                  className="st-iconbox st-style4 wow fadeIn"
                  data-wow-duration="1s"
                  data-wow-delay="0.2s"
                >
                  <div className="st-iconbox-icon st-pink">
                    <svg
                      version="1.1"
                  ...
                  <h3 className="st-iconbox-title">Financial Planning</h3>
                  <p className="st-iconbox-text">
              ...
              <div className="col-md-4">
                <div
                  ...
                  data-wow-delay="0.3s"
                >
                  <div className="st-iconbox-icon st-green">
                    <svg
                      version="1.1"
                      xmlns="http://www.w3.org/2000/svg"
                      xlink="http://www.w3.org/1999/xlink"
                  ...
                  <h3 className="st-iconbox-title">Business Growth</h3>
                  <p className="st-iconbox-text">
                    Disruptive innovation via workplace diversity and
                    empowerment. User generated content in real-time will have
                    multiple.
                  </p>
                </div>
                <div className="st-height-b0 st-height-lg-b30"></div>
              ...
              <div className="col-md-4">
                <div
                  ...
                  data-wow-delay="0.4s"
                >
                  <div className="st-iconbox-icon st-purple">
                  ...
                  <h3 className="st-iconbox-title">Business Strategy</h3>
                  <p className="st-iconbox-text">
        ...
        <section className="st-parallax">
          <div className="st-parallax-shape st-position2 st-to-left-up">
            <img src="/assets/img/shape/2.png" alt="" />
          </div>
          <div className="st-height-b120 st-height-lg-b50"></div>
          <div className="container">
            <div className="row">
              <div
                ...
                data-wow-delay="0.2s"
              >
                <div className="st-hobble">
                  <div className="st-video-box st-style1 text-center">
                    <div className="st-video-thumb st-hover-layer">
                      <img
                        src="/assets/img/video1.jpg"
                        alt="About demo video"
                        className="st-video-thumb-non-hover"
                      />
                    </div>
                    <a
                      href="https://www.youtube.com/embed/iHLOS7thkJs?autoplay=1"
                      className="st-play-btn st-video-open"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        xlink="http://www.w3.org/1999/xlink"
                ...
                <div className="st-height-lg-b50"></div>
              </div>
              <div
                ...
                <div className="st-vertical-middle">
                  <div className="st-vertical-middle-in">
                    <div className="st-about-text">
                      <h4 className="st-about-title">About Abid</h4>
                      <h2 className="st-about-head">
                        Stand out brands are built on 3 principles
                      </h2>
                      <p className="st-about-details">
                        Business is the activity of making one's living or
                        making money. One business makes a commercial
                        transaction with another. A business entity is an entity
                        that is formed and administered as corporate.
                      </p>
                      <ul className="st-about-list">
                        <li>
                          <i className="fas fa-arrow-right"></i>Insight
                        </li>
                        <li>
                          <i className="fas fa-arrow-right"></i>Intelligence
                        </li>
                        <li>
                          <i className="fas fa-arrow-right"></i>Design
                        </li>
                      </ul>
                      <div className="st-height-b35 st-height-lg-b35"></div>
                      <a
                        href="about.html"
                        className="btn st-btn-custom st-accent btn-md"
                      >
                        Read More
                      </a>
                    </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-5">
                <div
                  className="st-counter-head st-style1 wow fadeInLeft"
                  data-wow-duration="1s"
                  data-wow-delay="0.2s"
                >
                  <h2 className="st-counter-title">
                    We have more then 30 years of experience
                  </h2>
                  <p className="st-counter-subtitle">
                    Activity of buying or selling. Business is the activity of
                    making one's living or making money. One business makes a
              ...
              <div className="col-lg-7">
                <div className="st-vertical-middle">
                  <div className="st-vertical-middle-in">
                    <div className="st-counter-wrap st-style1">
                      <div
                        className="st-counter wow fadeIn"
                        data-wow-duration="1s"
                        data-wow-delay="0.3s"
                      >
                        <div className="st-counter-in">
                          <h3 className="st-counter-number">
                            <span className="st-counter-animation">500</span>+
                          </h3>
                          <p className="st-counter-text">Projects Done</p>
                        </div>
                      </div>
                      <div
                        className="st-counter wow fadeIn"
                      ...
                      >
                        <div className="st-counter-in">
                          <h3 className="st-counter-number">
                            <span className="st-counter-animation">1000</span>+
                          </h3>
                          <p className="st-counter-text">Happy Clients</p>
                        </div>
                      </div>
                      <div
                        className="st-counter wow fadeIn"
                      ...
                      >
                        <div className="st-counter-in">
                          <h3 className="st-counter-number">
                            <span className="st-counter-animation">50</span>+
                          </h3>
                          <p className="st-counter-text">Awards Win</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <hr />
        <section className="st-parallax">
          <div className="st-parallax-shape st-position3 st-to-up">
            <img src="/assets/img/shape/3.png" alt="" />
          </div>
          <div className="st-parallax-shape st-position4 st-to-left">
            <img src="/assets/img/shape/4.png" alt="" />
          </div>
          <div className="st-parallax-shape st-position5 st-to-rotate-up">
            <img src="/assets/img/shape/5.png" alt="" />
          </div>
          <div className="st-height-b120 st-height-lg-b80"></div>
          <div className="container">
            <div className="row">
              <div className="col-xl-12">
                <div
                  className="st-heading-section text-center wow fadeInUp"
                  data-wow-duration="1s"
                  data-wow-delay="0.2s"
                >
                  <h3 className="st-heading-title">
                    Featured service that we provide
                  </h3>
                  <p className="st-heading-text">
            ...
            <div className="row">
              <div className="col-xl-12">
                <div
                  className="st-iconbox-list wow fadeIn"
                  data-wow-duration="1s"
                  data-wow-delay="0.3s"
                >
                  <div className="st-iconbox st-style1 text-center">
                    <a
                      href="service-details.html"
                      className="st-iconbox-icon blue-icon"
                    >
                    ...
                    <h3 className="st-iconbox-title">
                      <a href="service-details.html">Strategy</a>
                    </h3>
                    <p className="st-iconbox-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing sed do
                      eiusmod tempor incididu labore etdolore magna aliqua.
                    </p>
                  </div>
                  <div className="st-iconbox st-style1 text-center">
                    <a
                      href="service-details.html"
                      className="st-iconbox-icon green-icon"
                    >
                      <svg viewBox="0 0 64 64">
                        <path
                    ...
                    <h3 className="st-iconbox-title">
                      <a href="service-details.html">Creative Production</a>
                    </h3>
                    <p className="st-iconbox-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing sed do
                      eiusmod tempor incididu labore etdolore magna aliqua.
                  ...
                  <div className="st-iconbox st-style1 text-center">
                    <a
                      href="service-details.html"
                      className="st-iconbox-icon red-icon"
                    >
                  ...
                  <div className="st-iconbox st-style1 text-center">
                    <a
                      href="service-details.html"
                      className="st-iconbox-icon purple-icon"
                    >
                  ...
                  <div className="st-iconbox st-style1 text-center">
                    <a
                      href="service-details.html"
                      className="st-iconbox-icon brown-icon"
                    >
                    ...
                    <h3 className="st-iconbox-title">
                      <a href="service-details.html">Analytical Reporting</a>
                    </h3>
                    <p className="st-iconbox-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing sed do
                      eiusmod tempor incididu labore etdolore magna aliqua.
                  ...
                  <div className="st-iconbox st-style1 text-center">
                    <a
                      href="service-details.html"
                      className="st-iconbox-icon magenta-icon"
                    >
                      <svg viewBox="0 0 512 512">
                        <g id="Outline">
                    ...
                    <h3 className="st-iconbox-title">
                      <a href="service-details.html">Digital Advertising</a>
                    </h3>
                    <p className="st-iconbox-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing sed do
                      eiusmod tempor incididu labore etdolore magna aliqua.
        ...
        <hr />
        <section className="st-parallax">
          <div className="st-parallax-shape st-position6 st-to-left">
          ...
          <div className="container">
            <div className="row">
              <div className="col-xl-12">
                ...
                >
                  <h3 className="st-heading-title">
                    Quick look of out polular product
                  </h3>
                  <p className="st-heading-text">
                    Business services are activities that combine consolida.
                  </p>
                </div>
              </div>
            </div>
            <div
              className="st-slider st-style2 wow fadeIn"
              data-wow-duration="1s"
              data-wow-delay="0.3s"
            >
              <div
              ...
              >
                <div className="slick-wrapper">
                  <div className="slick-slide-in">
                    <div className="st-product st-style1">
                      <div className="st-product-in">
                        <div className="st-product-thumb">
                          <a href="product-details.html">
                            <img src="/assets/img/product1.png" alt="Product" />
                          </a>
                          <div className="st-product-tools">
                            <ul>
                              <li>
                                <a href="#">
                        ...
                        <div className="st-product-details">
                          <div className="st-product-label">
                            <p className="st-product-price">$109</p>
                            <div className="st-star" data-star="5">
                              <div className="st-star-in"></div>
                            </div>
                          </div>
                          <h4 className="st-product-title">
                            <a href="product-details.html">
                              Men's Comfort Rubber Shoes
                            </a>
                          </h4>
                        </div>
                      </div>
                    ...
                    <div className="st-product st-style1">
                      <div className="st-product-in">
                        <div className="st-product-thumb">
                          ...
                          <span className="st-product-badge st-blue">New</span>
                        </div>
                        <div className="st-product-details">
                          <div className="st-product-label">
                            <p className="st-product-price">$199</p>
                            <div className="st-star" data-star="5">
                              <div className="st-star-in"></div>
                            </div>
                          </div>
                  ...
                  <div className="slick-slide-in">
                    <div className="st-product st-style1">
                      <div className="st-product-in">
                        ...
                        <div className="st-product-details">
                          <div className="st-product-label">
                            <p className="st-product-price st-offer">
                              $99{" "}
                              <span className="st-previous-price">$110</span>
                            </p>
                            <div className="st-star" data-star="4">
                              <div className="st-star-in"></div>
                            </div>
                          </div>
                          <h4 className="st-product-title">
                            <a href="product-details.html">
                              Men's Comfort Winter Sneakers
                            </a>
                          </h4>
                        </div>
                      </div>
              ...
              <div className="pagination st-style1 st-flex st-type1 st-hidden"></div>
              <div className="swipe-arrow st-style1">
                <div className="slick-arrow-left">
        ...
        <section className="st-gradient-bg st-parallax">
          <div className="st-parallax-shape st-position7 st-to-rotate-up">
            <img src="/assets/img/shape/7.png" alt="" />
          </div>
          <div className="st-parallax-shape st-position8 st-to-right-up">
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-5">
                <div
                  className="st-offer-img wow fadeInRight"
                  data-wow-duration="1s"
                  data-wow-delay="0.2s"
                >
              ...
              <div className="col-lg-7">
                <div
                  className="st-vertical-middle wow fadeIn"
                  data-wow-duration="1s"
                  data-wow-delay="0.3s"
                >
                  <div className="st-vertical-middle-in">
                    <div className="st-offer">
                      <div className="st-offer-info">
                        <h2 className="st-offer-title">
                          End of season clearnce flat <span>50%</span> Discount
                        </h2>
                        <p className="st-offer-desc">
                          There is very little time to buy the product as soon
                          as possible <br />
                          you buy the discount product
                        </p>
                      </div>
                      <div className="st-countdown-wrap">
                        <div className="st-countdown">
                          <div className="st-countdown-inner">
                            <h4 className="st-countdown-number" id="day">
                              07
                            </h4>
                            <p className="st-countdown-text">Days</p>
                          </div>
                        </div>
                        <div className="st-countdown">
                          <div className="st-countdown-inner">
                            <h4 className="st-countdown-number" id="hour">
                              12
                            </h4>
                            <p className="st-countdown-text">Hours</p>
                          </div>
                        </div>
                        <div className="st-countdown">
                          <div className="st-countdown-inner">
                            <h4 className="st-countdown-number" id="minute">
                              59
                            </h4>
                            <p className="st-countdown-text">Minutes</p>
                          </div>
                        </div>
                        <div className="st-countdown">
                          <div className="st-countdown-inner">
                            <h4 className="st-countdown-number" id="second">
                              07
                            </h4>
                            <p className="st-countdown-text">Seconds</p>
                          </div>
                        </div>
                      </div>
                      <a
        ...
        <section className="st-parallax">
          <div className="st-parallax-shape st-position9 st-to-up">
            ...
            <div className="row">
              <div className="col-xl-12">
                ...
                >
                  ...
                  <p className="st-heading-text">
                    Business services are activities that combine.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-xl-12">
                ...
                >
                  ...
                  >
                    <div className="slick-wrapper">
                      <div className="slick-slide-in">
                        <div className="st-testimonial st-style2">
                          <div className="st-testimonial-left">
                            <p className="st-testimonial-text">
                              "Leverage agile frameworks to provide a robust
                              synopsis for high level overviews. Iterative
                              approaches to corporate stra foster collaborative
                              thinking to further the overall value proposition.
                              Organically grow the holistic world."
                            </p>
                            <div className="st-testimonial-info">
                              <img
                                src="/assets/img/testimonial-sm1.jpg"
                                className="st-avatar-img"
                                alt="Client Avatar"
                              />
                              <div className="st-testimonial-meta text-left">
                                <h4 className="st-testimonial-avatar">
                                  Myrtle Dietz
                                </h4>
                                <p className="st-testimonial-avatar-designation">
                                  Director
                                </p>
                              </div>
                            </div>
                          </div>
                          <div className="st-testimonial-right">
                            <div
                              className="st-testimonial-img"
                              data-src="/assets/img/testimonial-lg1.jpg"
                            >
                              <a
                                href="https://www.youtube.com/embed/iHLOS7thkJs?autoplay=1"
                                className="st-play-btn st-video-open"
                      ...
                      <div className="slick-slide-in">
                        <div className="st-testimonial st-style2">
                          <div className="st-testimonial-left">
                            ...
                            <div className="st-testimonial-info">
                              <img
                                src="/assets/img/testimonial-sm2.jpg"
                                className="st-avatar-img"
                                alt="Client Avatar"
                              />
                              <div className="st-testimonial-meta text-left">
                          ...
                          <div className="st-testimonial-right">
                            <div
                              className="st-testimonial-img"
                              data-src="/assets/img/testimonial-lg2.jpg"
                            >
                              <a
                                href="https://www.youtube.com/embed/iHLOS7thkJs?autoplay=1"
                                className="st-play-btn st-video-open"
                      ...
                      <div className="slick-slide-in">
                        <div className="st-testimonial st-style2">
                          <div className="st-testimonial-left">
                            ...
                            <div className="st-testimonial-info">
                              <img
                                src="/assets/img/testimonial-sm3.jpg"
                                className="st-avatar-img"
                                alt="Client Avatar"
                              />
                              <div className="st-testimonial-meta text-left">
                          ...
                          <div className="st-testimonial-right">
                            <div
                              className="st-testimonial-img"
                              data-src="/assets/img/testimonial-lg3.jpg"
                            >
                              <a
                                href="https://www.youtube.com/embed/iHLOS7thkJs?autoplay=1"
                                className="st-play-btn st-video-open"
                  ...
                  <div className="pagination st-style1 st-type1 st-hidden"></div>
                  <div className="swipe-arrow st-style1">
                    <div className="slick-arrow-left">
                      <i className="fa fa-chevron-left"></i>
                    </div>
        ...
        <hr />
        <section className="st-parallax">
          <div className="st-parallax-shape st-position10 st-to-up">
          ...
          <div className="container">
            ...
            >
              <div className="col-lg-4">
                <div className="st-post st-style1 text-center">
                  <a
                    href="blog-details-right-sidebar.html"
                    className="st-post-thumb"
                  >
                  ...
                  <div className="st-post-info">
                    <div className="st-post-head">
                      <div className="st-post-label">
                        <span className="st-posted-by">
                          <a href="#">Raul Dev</a>
                        </span>
                        <span className="st-post-date">March 01, 2020</span>
                      </div>
                    ...
                    <div className="st-post-btn-wrap">
                      <a
                        href="blog-details-right-sidebar.html"
                ...
                <div className="st-post st-style1 text-center">
                  ...
                  <div className="st-post-info">
                    <div className="st-post-head">
                      ...
                      <h4 className="st-post-title">
                        <a href="blog-details-right-sidebar.html">
                          Write a business plan for any situa
                        </a>
                      </h4>
                    </div>
                    <div className="st-post-btn-wrap">
                ...
                <div className="st-post st-style1 text-center">
                  ...
                  <div className="st-post-info">
                    <div className="st-post-head">
                      ...
                      <h4 className="st-post-title">
                        <a href="blog-details-right-sidebar.html">
                          Successful business goals & plans
                        </a>
                      </h4>
                    </div>
                    <div className="st-post-btn-wrap">
              ...
              <div className="col-xl-12">
                ...
                >
                  ...
                  >
                    <div className="slick-wrapper">
                      <div className="slick-slide-in">
                        <div className="single-brand-thumb style1">
                          <img
                  ...
                  <div className="pagination st-style1 st-type1 st-flex st-hidden"></div>
                  <div className="swipe-arrow st-style1">
                    <div className="slick-arrow-left">
                      <i className="fa fa-chevron-left"></i>
                    </div>
