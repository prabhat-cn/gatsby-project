  ...
  <div class="st-content">
    <section class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
      ...
      <div class="st-slider st-style1">
        ...
        <div class="pagination st-style1 st-type3"></div>
          ...
          <div class="col-md-4">
            <div class="st-iconbox st-style4 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
              <div class="st-iconbox-icon st-pink">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 432.4 432.4" space="preserve" >
            ...
            <div class="st-hobble">
              <div class="st-video-box st-style1 text-center">
                ...
                <a href="https://www.youtube.com/embed/iHLOS7thkJs?autoplay=1" class="st-play-btn st-video-open">
                  <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="23px" height="27px">
            ...
            <div class="st-vertical-middle">
              <div class="st-vertical-middle-in">
                <div class="st-about-text">
                  ...
                  <p class="st-about-details">Business is the activity of making one's living or making money. One business makes a commercial transaction with another. A business entity is an entity that is formed and administered as corporate.</p>
          ...
          <div class="col-xl-12">
            <div class="st-iconbox-list wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="st-iconbox st-style1 text-center">
                <a href="service-details.html" class="st-iconbox-icon blue-icon">
              ...
              <div class="st-iconbox st-style1 text-center">
                <a href="service-details.html" class="st-iconbox-icon green-icon">
                  <svg viewBox="0 0 64 64">
                ...
                <p class="st-iconbox-text">Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod tempor incididu labore etdolore magna aliqua.</p>
              </div>
              <div class="st-iconbox st-style1 text-center">
                <a href="service-details.html" class="st-iconbox-icon red-icon">
              ...
              <div class="st-iconbox st-style1 text-center">
                <a href="service-details.html" class="st-iconbox-icon purple-icon">
              ...
              <div class="st-iconbox st-style1 text-center">
                <a href="service-details.html" class="st-iconbox-icon brown-icon">
              ...
              <div class="st-iconbox st-style1 text-center">
                <a href="service-details.html" class="st-iconbox-icon magenta-icon">
                  <svg viewBox="0 0 512 512">
                    <g id="Outline">
                      <path
              ...
              <div class="st-vertical-middle-in">
                <div class="st-offer">
                  <div class="st-offer-info">
                    ...
                    <p class="st-offer-desc">There is very little time to buy the product as soon as possible <br/>you buy the
                      discount product</p>
                  </div>
              ...
              <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="800" data-autoplay-timeout="1000" data-center="0" data-slides-per-view="1" data-fade-slide="0">
                <div class="slick-wrapper">
                  <div class="slick-slide-in">
                    <div class="st-testimonial st-style2">
                      <div class="st-testimonial-left">
                        <p class="st-testimonial-text">"Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate stra foster collaborative thinking to further the overall value proposition. Organically grow the holistic world."</p>
                  ...
                  <div class="slick-slide-in">
                    <div class="st-testimonial st-style2">
                      <div class="st-testimonial-left">
                        <p class="st-testimonial-text">"Bring to the table win-win survival strategies to ensure proactive domination. At the end of the day, going forward, a new normal that has evolved from generation X is on the runway heading towards a streamlined cloud solution."</p>
                        <div class="st-testimonial-info">
                          <img src="assets/img/testimonial-sm2.jpg" class="st-avatar-img" alt="Client Avatar" />
                          <div class="st-testimonial-meta text-left">
                  ...
                  <div class="slick-slide-in">
                    <div class="st-testimonial st-style2">
                      <div class="st-testimonial-left">
                        <p class="st-testimonial-text">"Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway."</p>
                        <div class="st-testimonial-info">
                          <img src="assets/img/testimonial-sm3.jpg" class="st-avatar-img" alt="Client Avatar" />
                          <div class="st-testimonial-meta text-left">
